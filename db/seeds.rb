...
Url.create(link:"https://upload.wikimedia.org/wikipedia/commons/1/12/Bigroom_house_drop_loop_30_sec.ogg", name:"Bigroom - House Drop", desc:"House")
...
Url.create(name: "House Beat", desc: "House", link: "https://upload.wikimedia.org/wikipedia/commons/c/c0/-_4_rndd%21.flac")
...
Url.create(name: "Javier Zugarramurdi - Techdombe", desc: "Techno", link: "https://upload.wikimedia.org/wikipedia/commons/c/c8/Javier_Zugarramurdi_-_Techdombe.wav")
...
Track.create(url_id: nil, track_number: nil, in: nil, out: nil, tempo: nil, volume: nil, pitch: nil)
Track.create(url_id: nil, track_number: nil, in: nil, out: nil, tempo: nil, volume: nil, pitch: nil)
Track.create(url_id: nil, track_number: nil, in: nil, out: nil, tempo: nil, volume: nil, pitch: nil)
Track.create(url_id: nil, track_number: nil, in: nil, out: nil, tempo: nil, volume: nil, pitch: nil)
Track.create(url_id: nil, track_number: nil, in: nil, out: nil, tempo: nil, volume: nil, pitch: nil)
...
Track.create(url_id: nil, track_number: nil, in: nil, out: nil, tempo: nil, volume: nil, pitch: nil)
Track.create(url_id: nil, track_number: nil, in: nil, out: nil, tempo: nil, volume: nil, pitch: nil)
Track.create(url_id: nil, song_id: nil, track_number: nil, in: nil, out: nil, tempo: nil, volume: nil, pitch: nil)
Track.create(url_id: nil, song_id: nil, track_number: nil, in: nil, out: nil, tempo: nil, volume: nil, pitch: nil)
Track.create(url_id: nil, song_id: nil, track_number: nil, in: nil, out: nil, tempo: nil, volume: nil, pitch: nil)
Track.create(url_id: nil, song_id: nil, track_number: nil, in: nil, out: nil, tempo: nil, volume: nil, pitch: nil)
Track.create(url_id: nil, song_id: nil, track_number: nil, in: nil, out: nil, tempo: nil, volume: nil, pitch: nil)
